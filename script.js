...
.brand img{ height:60px; width:auto; transition:transform 0.3s ease; }
...
/* ======= 導覽列（僅保留間距設定） ======= */
.site-title { margin-right:48px; }
.nav-links { display:flex; gap:40px; }
.nav-links a { text-decoration:none; color:#333; font-weight:600; transition:color 0.2s, transform 0.2s; }
.nav-links a:hover { color:#ff9800; transform:translateY(-1px); }
